...
$datainicialcorrecao=$_POST['datainicialcorrecao'];
...
$query = $pdo->prepare("INSERT INTO $tabela SET processo = :processo, vara = :vara, exequente = :exequente, executado = :executado, datainicialcorrecao = :datainicialcorrecao, datainicialjuros = :datainicialjuros, datafinaljuros = :datafinaljuros, dataevento = :dataevento, historico = :historico, valor = :valor, indicecorrecao = :indicecorrecao, juros = :juros, total = :total");
...
$query->bindValue(":datainicialcorrecao","$datainicialcorrecao");
